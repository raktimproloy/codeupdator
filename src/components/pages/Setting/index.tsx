              ...
              <div className="col-span-full xl:col-auto">
                <div className="p-4 mb-4 shadow border border-base-300 rounded-lg 2xl:col-span-2 sm:p-6">
                  <div className="flex flex-col justify-center items-center space-x-4  2xl:space-x-4">
                    <img
                      className="mb-4 w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0 rounded-full"
                  ...
                  <div className="flow-root">
                    ...
                    <ul className="divide-y">
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <textarea id="bio" className="textarea textarea-bordered w-full mb-2" placeholder="Bio">xxxxxx</textarea>
                      </div>
                ...
                <div className="p-4 mb-4 shadow border border-base-300 rounded-lg 2xl:col-span-2">
                  <div className="flow-root">
                    ...
                    <ul className="divide-y">
                      <li className="py-4">
                        <div className="mb-3 w-full flex space-x-1 mt-3"><span className="indicator-item indicator-top indicator-start badge badge-success text-white rounded">Node js</span><span className="indicator-item indicator-top indicator-center badge badge-secondary rounded">PHP</span><span className="indicator-item indicator-middle indicator-start badge badge-neutral rounded">Laravel</span><span className="indicator-item indicator-middle indicator-center badge badge-warning rounded">HTML</span></div>
                        <div>
                  ...
                  <form action="#">
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" id='first-name' placeholder="Joshim" className="input input-bordered w-full max-w-xs" />
                      </div>
                      <div className="col-span-6 sm:col-span-3">
                        <label
                          htmlFor="last-name"
                        ...
                        <input type="text" id='last-name' placeholder="Uddin" className="input input-bordered w-full max-w-xs" />
                      </div>
                      <div className="col-span-6 sm:col-span-3">
                        <label
                          htmlFor="email"
                        ...
                        <input type="text" id='email' placeholder="JoshimUddin8212@gmail.com" className="input input-bordered w-full max-w-xs" />
                      </div>
                      <div className="col-span-6 sm:col-span-3">
                        <label
                          htmlFor="username"
                        ...
                        <input type="text" id='username' placeholder="joshim_laravelest" className="input input-bordered w-full max-w-xs" />
                      </div>
