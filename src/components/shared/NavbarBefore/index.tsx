    ...
    <>
      ...
      <nav className="flex-no-wrap fixed top-0 z-10 w-full items-center justify-between bg-[#FBFBFB] shadow-md shadow-black/2 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-1 bg-white border-gray-200 dark:bg-gray-900 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <ul className="flex justify-center items-center mt-4 font-medium md:mt-0 md:space-x-4 xl:space-x-8 rtl:space-x-reverse">
              <li>
                <Link
                  href="/"
              ...
              {/* MVP(Most valueable programmer)  heroes */}
              <li>
                <Link
                  href="/about"
                  className="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
